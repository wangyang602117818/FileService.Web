            ...
            if (!databases.Contains("Config"))
            {
                ...
                List<BsonDocument> list = new List<BsonDocument>()
                {
                    new BsonDocument(){
                        ...
                        { "Description", ""},
                        { "CreateTime", DateTime.Now } },
                    new BsonDocument(){{"Extension", ".png" },{"Type", "image" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now } },
                    new BsonDocument(){{"Extension", ".gif" },{"Type", "image" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now } },
                    new BsonDocument(){{"Extension", ".bmp" },{"Type", "image" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now } },
                    new BsonDocument(){{"Extension", ".mp4" },{"Type","video" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".avi" },{"Type", "video" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".wmv" },{"Type", "video" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".m3u8" },{"Type", "video" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".doc" },{"Type", "office" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".docx" },{"Type", "office" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".xls" },{"Type", "office" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".xlsx" },{"Type", "office" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".ppt" },{"Type", "office" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".pptx" },{"Type", "office" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".txt" },{"Type", "text" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".js" },{"Type", "text" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".htm" },{"Type", "text" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".html" },{"Type", "text" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".css" },{"Type", "text" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".zip" },{"Type", "attachment" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".rar" },{"Type", "attachment" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
                    new BsonDocument(){{"Extension", ".pdf" },{"Type", "pdf" }, { "Action","allow"}, { "Description", "" }, { "CreateTime", DateTime.Now }},
